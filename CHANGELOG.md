...
- `dataframeit` — documenta que a biblioteca injeta `temperature=0` e que modelos sem `temperature` (Claude Sonnet 5, Opus 4.7+, GPT-6 com raciocinio, o1/o3, Gemini 3.6+) precisam de `model_kwargs={'temperature': None}`.
